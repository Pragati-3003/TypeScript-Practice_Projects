...
const inputlabel = document.getElementById("todoInput") as HTMLInputElement;
const button = document.getElementById("addBtn") as HTMLButtonElement;
const Ulist = document.getElementById("todoList") as HTMLUListElement;
...
const renderTodos = (): void => {
    ...
    todos.forEach((todo) => {
        ...
        textSpan.addEventListener("click", (): void => {
